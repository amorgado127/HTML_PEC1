...
window.onload = function () {
  const data = {
    ...
    libros: [
      ...
      },
      {
        ...
        resumen:
          "<b>Una catedral construida por el pueblo y para el pueblo en la Barcelona medieval es el escenario de una apasionante historia de intriga, violencia y pasión.</b>|    <b>Siglo XIV</b>. La ciudad de Barcelona se encuentra en su momento de mayor prosperidad; ha crecido hacia la Ribera, el humilde barrio de los pescadores, cuyos habitantes deciden construir, con el dinero de unos y el esfuerzo de otros, el mayor templo mariano jamás conocido: Santa María de la Mar.| Una construcción que es paralela a la azarosa historia de Arnau, un siervo de la tierra que huye de los abusos de su señor feudal y se refugia en Barcelona, donde se convierte en ciudadano y, con ello, en hombre libre.| El joven Arnau trabaja como palafrenero, estibador, soldado y cambista. Una vida extenuante, siempre al amparo de la catedral de la mar, que le iba a llevar de la miseria del fugitivo a la nobleza y la riqueza. Pero con esta posición privilegiada también le llega la envidia de sus pares, que urden una sórdida conjura que pone su vida en manos de la Inquisición...",
        resumen_corto:
      ...
      },
      {
        ...
        resumen: "Valiéndose de las características de la novela gótica, la crónica medieval y la novela policíaca,El nombre de la rosa narra las investigaciones detectivescas que realiza el fraile franciscano Guillermo de Baskerville para esclarecer los crímenes cometidos en una abadía benedictina en el año 1327. Le ayudará en su labor el novicio Adso, un joven que se enfrenta por primera vez a las realidades de la vida situadas más allá de las puertas del convento.|En esta primera y brillante incursión de Umberto Eco en el mundo de la narrativa, que dio lugar a una manera de concebir la novela histórica, el lector disfrutará de una trama apasionante y una admirable reconstrucción de una época especialmente conflictiva de la historia de Occidente.",
        resumen_corto: "El nombre de la rosa narra las investigaciones detectivescas que realiza el fraile franciscano Guillermo de Baskerville para esclarecer los crímenes cometidos en una abadía benedictina en el año 1327. ",
        video:"",
      },
        ...
        },
      {
        ...
        resumen_corto: "Julia Navarro se consagra con esta electrizante novela en la que el lector viajará hasta los tiempos bíblicos pasando por la Europa de la Segunda Guerra Mundial, Egipto, Siria, Estados Unidos, Italia, Francia, España y el Irak de Sadam.",
        video:"",
      },
  
      {
        ...
        resumen_corto: "Tras las míticas piezas de ajedrez de Montglane se oculta un secreto celosamente preservado durante siglos...",
        video:"",
      },
      {
        categoria: 1,
  ...
  libros.forEach((libro) => {
    if (primero) {
      ...
      resumen[0].href = libro.resumen_corto;
    } else {
